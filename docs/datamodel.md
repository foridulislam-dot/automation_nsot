আগের চ্যাপ্টারে আমরা Nautobot 3.0 ইনস্টল করলাম। Nirvor Communication Bangladesh এর NOC টিম এখন একটা চালু Nautobot instance পেয়েছে। কিন্তু এখনও কোনো ডেটা নেই - খালি একটা সিস্টেম। ডেটা এন্ট্রি শুরু করার আগে বুঝতে হবে Nautobot কীভাবে নেটওয়ার্ক ডেটা স্টোর করে, কীভাবে বিভিন্ন জিনিস একে অপরের সাথে সম্পর্কিত।

এই চ্যাপ্টারে আমরা Nautobot 3.0 এর ডেটা মডেল বুঝব। এটা একটু থিওরি মনে হতে পারে, কিন্তু এই ফাউন্ডেশন না বুঝলে পরে ডেটা এন্ট্রি করতে গিয়ে সমস্যা হবে। Nirvor Communication Bangladesh এর নেটওয়ার্ককে উদাহরণ হিসেবে ব্যবহার করে প্রতিটা কনসেপ্ট ব্যাখ্যা করব।
...
Nirvor Communication Bangladesh এর নেটওয়ার্ক ঢাকা নর্থ জোনে ছড়িয়ে আছে। তাদের এই স্ট্রাকচার:

```
Nirvor Communication Bangladesh Network
  └── Dhaka North Zone
       ├── Mirpur Cluster
       │    └── Mirpur POP
       │         ├── Rack A
...
Nirvor Communication Bangladesh এর দুটো ব্র্যান্ড আছে:
...
Nirvor Communication Bangladesh এর টিম:
...
Nirvor Communication Bangladesh MikroTik router ব্যবহার করে। তাদের main model হলো CCR2004-1G-12S+2XS।
...
Nirvor Communication Bangladesh এর Mirpur POP এ একটা core router আছে:
...
Nirvor Communication Bangladesh এর convention:
```
...
**Nirvor Communication Bangladesh এর ক্ষেত্রে:**
...
Nirvor Communication Bangladesh এর কাছে BTCL থেকে পাওয়া একটা /22 public IP block আছে:
...
Nirvor Communication Bangladesh এর VLAN structure:
...
যেকোনো ISP এর নিজের uplink provider থাকে। Nirvor Communication Bangladesh BTCL থেকে ইন্টারনেট নেয়।
...
Nirvor Communication Bangladesh এর Device Roles:
...
Nirvor Communication Bangladesh একটা custom status যোগ করেছে:
...
Nirvor Communication Bangladesh এর দরকার warranty tracking:
...
এখন দেখি কীভাবে সব একসাথে কাজ করে। Nirvor Communication Bangladesh এর Mirpur POP এর একটা সম্পূর্ণ উদাহরণ:
