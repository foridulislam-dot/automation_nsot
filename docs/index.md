---
title: 'আইএসপি অটোমেশন সিরিজ (২): ১ মিলিয়ন ইন্টারনেট গ্রাহকের আইএসপি'
---

### রোড টু হাইটেক ইন্ডাস্ট্রি সিরিজ: ড্রাফট

!!! tldr "বইটা এখনো ড্রাফট"
    আইএসপি এবং নেটওয়ার্ক অটোমেশন নিয়ে প্রথম বইটা লেখার পর বেশ ভালো সাড়া পেয়েছি। রকমারিতে নেটওয়ার্কিংয়ের বেস্ট সেলার লিস্টে আসাতে মনে হলো বইটার একটা দ্বিতীয় পর্ব আনা যায়। নেটওয়ার্কে কিভাবে কৃত্রিম বুদ্ধিমত্তা, এআই (চ্যাটজিপিটি এর মতো লার্জ ল্যাঙ্গুয়েজ) আনা যায় সেটাই টোন সেট করবে এই বইটা। এআইকে ঠিকমতো চালাতে দরকার সঠিক ডাটা একটা জায়গায়। সেটাকে বলা হয় নেটওয়ার্ক সোর্স অফ ট্রুথ। এটাকে ঠিক করলেই এআইকে চালানো সম্ভব।
